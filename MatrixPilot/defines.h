...
#if((HILSIM == 1) && (HILSIM_FAST_STANDBY == 1))
#define CALIB_PAUSE 4		// wait for 2 seconds of runs through the state machine
#define STANDBY_PAUSE 8		// pause for 4 seconds of runs through the state machine
#else
