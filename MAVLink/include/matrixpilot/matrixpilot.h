...
/** @brief How SITL is configured to override normal UDB operations */
#ifndef HAVE_ENUM_MAV_SITL_OVERRIDE_MODE
#define HAVE_ENUM_MAV_SITL_OVERRIDE_MODE
enum MAV_SITL_OVERRIDE_MODE
{
...
/** @brief How the override array relates to specific autopilot controls */
#ifndef HAVE_ENUM_MAV_SITL_OVERRIDE_AP_CONTROLS
#define HAVE_ENUM_MAV_SITL_OVERRIDE_AP_CONTROLS
enum MAV_SITL_OVERRIDE_AP_CONTROLS
{
...
#include "./mavlink_msg_sitl_imu_output.h"
#include "./mavlink_msg_sitl_ap_control.h"
